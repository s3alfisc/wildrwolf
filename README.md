...
# set seed twice, as wild cluster bootstrap in 
# fwildclusterboot generates random numbers based on 
# seed controlled via set.seed() and dqrng::dqset.seed()

set.seed(1412)
dqrng::dqset.seed(6543)
...
#> 3     3 -0.007682607 0.04222391 -0.1819492     0.8556595      0.9806
#> 4     4  -0.02689601 0.03050616 -0.8816584     0.3781741      0.8528
#> 5     5     0.411529 0.04299497   9.571561    7.9842e-21      0.0001
#> 6     6    0.3925661 0.03096423   12.67805  2.946569e-34      0.0001
#> 7     7    0.0206361 0.04405654  0.4684003     0.6396006      0.9508
#> 8     8  0.001657765 0.03337464 0.04967138     0.9603942      0.9806
```
...
#> 3     3 -0.007682607 0.04403736 -0.1744566      0.861542      0.8587
#> 4     4  -0.02689601 0.03130345 -0.8592027     0.3904352      0.6148
```
...
#>  Romano-Wolf 12.63678 12.63678 12.63678 12.63678 12.63678 12.63678     1
```
...
#> fit_pvalue         0.251     0.470 0.5
#> fit_pvalue_holm    0.046     0.092 0.5
#> fit_padjust_rw     0.042     0.093 0.5
```
...
#> 2     2 -0.02689601 0.03050616 -0.8816584     0.3781741      0.6134
#> 3     3   0.3925661 0.03096423   12.67805  2.946569e-34      0.0001
#> 4     4 0.001657765 0.03337464 0.04967138     0.9603942      0.9592
```
